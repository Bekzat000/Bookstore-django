...
var actions={reader_settings:{},init:function(){this.bind();this.init_gotop_button();this.init_short_description();this.init_body_click();this.init_download_page();this.init_reading_page();this.resizeTextareaOnInput();this.resizeContainerHeight();this.init_gotop_button()},bind:function(){$(".tap_ifo").click(this.tap_book_info);$(".item").click(this.item_click);$(".star").click(this.vote_book);$(".search_icon").click(this.show_search_form);$(".menu_btn").click(this.show_mobile_menu);$("#search-txt").keyup(this.show_suggest);$(".user_block").click(this.init_toggle);$(".book_action").click(this.init_toggle);$(".follow_action").click(this.follow_user);$(".books .list_action").click(this.init_toggle);$(".user_action").click(this.action_handlers);$(".auth_form").click(authorization.get_auth_block);$(".log_out").click(authorization.logout);$("#read_online").click(this.read_online);$(".d-btn").click(this.open_donwload_page);$(".s-list").click(this.sort_page);$(".expand_btn").click(this.show_subgenres);$(".month_block, .year_block").change(this.change_count_days);$(".save_settings").click(this.save_settigs);$(".show_more_cmt .btn").click(this.show_more_comments);$(document).on("scroll",this.showLazyImg);$(function(a){actions.showLazyImg(a)});$(".sorting_block .checked").click(this.init_toggle_sorting_block);$(".sorting_block .sort_btn").click(this.changeListView);$(".sorting_block .only_full_books").change(this.showOnlyFullBooks);$(".users_count span").click(this.show_book_users_popup)},changeListView:function(){if($(this).hasClass("btn_desr")){$.cookie("list_view","wdesc",{path:"/"})}else{$.cookie("list_view","images",{path:"/"})}window.location.reload()},showOnlyFullBooks:function(){if($(this).is(":checked")){$.cookie("list_view_full_books","1",{path:"/"})}else{$.cookie("list_view_full_books","0",{path:"/"})}var a=$(this).data("p");if(a){window.location.href=$(this).data("p")}else{window.location.reload()}},show_book_users_popup:function(){if($("#book_users_block").length){$("#book_users_block .popup_users").toggle();return false}$.post("/api/addAction.php",{t:"book_users",b:$(".book_info").data("bid")},function(a){if(a.status=="OK"){$(".users_count").append(a.content)}},"json")},resizeContainerHeight:function(){var c=".main_container .right_clmn .content, .main_container.books";var a=$(window).height();var b=$(c).height();if(b&&b+215<a){$(c).height(a-215)}},resizeTextareaOnInput:function(){var a=$(".comment_div");a.each(function(){this.setAttribute("style","overflow-y:hidden;")}).on("input",function(){var b=this.scrollHeight;if(b>120){this.style.height="auto";this.style.height=(this.scrollHeight)+"px"}})},init_toggle:function(){if($(this).hasClass("is_show")){$(this).removeClass("is_show")}else{$(this).addClass("is_show")}},init_toggle_sorting_block:function(){if($(this).parent().hasClass("is_show")){$(this).parent().removeClass("is_show")}else{$(".sorting_block .sort").removeClass("is_show");$(this).parent().addClass("is_show")}},init_short_description:function(){var a=$(".wrap_description").height();if($(".wrap_description").hasClass("expand")&&a>380){$(".wrap_description").height("350px");$(".wrap_description").append('<div class="review_open"></div>');$(".review_open").click(this.show_full_description)}},init_gotop_button:function(){$(window).scroll(function(){if($(".go_top_button").length){var a=$("html,body").scrollTop();var b=$(document).width();if(a>400&&b>1100){$(".go_top_button").fadeIn(200)}else{$(".go_top_button").fadeOut(200)}}});$(".go_top_button").click(function(){$("html,body").animate({scrollTop:0},400)})},init_download_page:function(){if($(".book_info").hasClass("download")){$(".progress_bar").jQMeter({bgColor:"#ececec",barColor:"#1cbbb4",goal:"100",raised:"100",width:"100%",height:"4px",margin:"30",animationSpeed:1500,displayTotal:false});if($("#ext_frame").length){$("#ext_frame").remove()}var a=$(".book_info").data("bid");var c=$(".book_info").data("format");setTimeout(function(){var b='<iframe id="ext_frame" scrolling="no" frameborder="0" allowtransparency="true" height="0" width="0" style="border:0;" src="/api/get.php?b='+a+"&f="+c+'"></iframe>';$("body").append(b)},1000)}},init_reading_page:function(){if(!$("body").hasClass("reading_body")){return false}actions.reader_settings={fs:15+parseInt($(".input_range.font-size").val()),lh:26+parseInt($(".input_range.line-height").val())*3,tw:(2-parseInt($(".input_range.text-width").val()))*30,ff:$(".font_row.current").html(),cs:$(".reading_body").css("color")+","+$(".reading_body").css("background-color"),cs_num:$(".input_range.color-scheme").val()};$("#show_reading_settings").click(function(){if($(".settings_dropdown").hasClass("is_show")){$(".settings_dropdown").removeClass("is_show")}else{$(".settings_dropdown").addClass("is_show")}});$(".font_current_row").click(function(){if($(".font_changer").hasClass("is_show")){$(".font_changer").removeClass("is_show")}else{$(".font_changer").addClass("is_show")}});$(".input_range").change(this.change_input_range);$(".input_range").on("mousemove change",this.change_input_range);$(".settings_block .font_row").click(function(){$(this).parent().find(".font_row").removeClass("current");$(this).addClass("current");$(".font_current_row").html('<span class="icon"></span>'+$(this).html());$(".font_changer").removeClass("is_show");$(".wrap_reading_text").css("font-family",$(this).html());actions.reader_settings.ff=$(this).html();actions.set_reading_settings()});$(".return_settings").click(function(){$.cookie("reading_settings",null,{path:"/"});window.location.reload()})},change_input_range:function(){var b=$(this).val()/$(this).attr("max");var h="-webkit-gradient(linear, left top, right top, color-stop("+b+", #1aafa8), color-stop("+b+", #cbcbcb))";$(this).css("background-image",h);if($(this).hasClass("font-size")){var a=15+parseInt($(this).val())*2;$(".wrap_reading_text").css("font-size",a+"px");actions.reader_settings.fs=a}if($(this).hasClass("line-height")){var e=26+parseInt($(this).val())*4;$(".wrap_reading_text").css("line-height",e+"px");actions.reader_settings.lh=e}if($(this).hasClass("text-width")){var d=(2-parseInt($(this).val()))*30;$(".wrap_reading_text").css("margin","40px "+d+"px 30px "+d+"px");actions.reader_settings.tw=d}if($(this).hasClass("color-scheme")){var g=["#000000","#000000","#000000","#000000","#E8D9BF","#EDE0CB","#F1E8D8","#F6EFE5","#FAF8F2","#FFFFFF"];var c=["#676767","#848484","#ABACAC","#FFFFFF","#000000","#000000","#000000","#000000","#000000","#000000"];var f=parseInt($(this).val());$(".reading_body").css("background-color",g[f]);$(".reading_body").css("color",c[f]);actions.reader_settings.cs=c[f]+","+g[f];actions.reader_settings.cs_num=f}actions.set_reading_settings()},set_reading_settings:function(){$.cookie("reading_settings",JSON.stringify(actions.reader_settings),{path:"/"})},show_more_comments:function(){$(this).hide();$(".reviews_container li").removeClass("more_cmts")},show_full_description:function(){$(".review_open").css("height","");$(".wrap_description").animate({height:"100%"},"slow");$(".review_open").hide()},init_body_click:function(){$(document).bind("click",function(b){var a=$(document).width();var d=$(b.target);if(!d.parents().andSelf().hasClass("book_action")&&$(".book_action").hasClass("is_show")){$(".book_action").removeClass("is_show")}if(!d.parents().andSelf().hasClass("settings_dropdown")&&$(".settings_dropdown").hasClass("is_show")){$(".settings_dropdown").removeClass("is_show")}if(!d.parents().andSelf().hasClass("sorting_block")&&$(".sorting_block .sort").hasClass("is_show")){$(".sorting_block .sort").removeClass("is_show")}if(!d.parents().andSelf().hasClass("list_action")&&$(".list_action").hasClass("is_show")){$(".list_action").removeClass("is_show")}if(!d.parents().andSelf().hasClass("popup_users")&&$(".popup_users").css("display")=="block"){$(".popup_users").hide()}if(a<990&&!d.hasClass("menu_btn")&&!d.parents().andSelf().hasClass("header_menu")&&$(".header_menu").css("display")=="block"){actions.show_mobile_menu()}if(!d.hasClass("search_icon")&&!d.parents().andSelf().hasClass("wrap_search")&&$(".wrap_search").hasClass("is_show")){$(".wrap_search").removeClass("is_show");if(a>990){$(".header_menu").show()}}})},change_count_days:function(){if($(".day_block").val()){return}var a=new Date($(".year_block").val(),$(".month_block").val(),0).getDate();var b='<option selected="" value=""></option>';for(i=1;i<=a;i++){b+='<option value="'+i+'">'+i+"</option>"}$(".day_block").html(b)},read_online:function(){var a=window.location.href;if($(this).hasClass("mobile")){a=a.replace("/book/","/read-book/mobile/")}else{a=a.replace("/book/","/read-book/");var b=$(this).data("p");if(b){a+="?p="+b}}window.open(a,"_blank");return false},open_donwload_page:function(){var a=window.location.href.split("?")[0];a=a.replace("/book/","/download/")+"?f="+$(this).data("format");if($(this).data("t")=="b"){window.open(a,"_blank")}else{window.location.href=a}return false},sort_page:function(){var a=$(this).parent().data("u")?$(this).parent().data("u"):window.location.href.split("?")[0];var b=$(this).data("s");if(b){a+="?sort="+b}if($(this).data("t")=="b"){window.open(a,"_blank")}else{window.location.href=a}return false},tap_book_info:function(){var b=$(this);var a=b.closest(".book").find(".hover_info");if(a.hasClass("is_show")){a.removeClass("is_show");b.removeClass("close")}else{b.addClass("close");a.addClass("is_show")}},show_subgenres:function(a){a.stopPropagation();var b=$(this).closest("li");if(b.hasClass("show_tree")){b.removeClass("show_tree")}else{b.addClass("show_tree")}},item_click:function(d){var b=$(this);var f=$(d.target);if(b.is("a")){return}if(b.hasClass("full_block")){var a=b.find(".book").find("a:first").attr("href")}else{var a=b.find("a:first").attr("href")}if(typeof(a)!=="undefined"&&!f.hasClass("tap_ifo")){window.location.href=a}},vote_book:function(){var a=$(this).data("rating");var b=$(this);$.post("/api/addAction.php",{t:"user_vote",b:$(".book_info").data("bid"),vote:a},function(d){if(d.status=="OK"){$(".vote_count").html(d.text);$(".rating").html(d.rating);$(".wrap_stars .fill").css("width",(a*20).toString()+"%");var c=350*d.rating/5;if(c>180){$(".w-spin").removeClass("w50")}else{$(".w-spin").addClass("w50")}$(".pie .spinner").css({transform:"rotate("+c.toString()+"deg)"});var e=$(".review_form").offset().top-70;$("html,body").animate({scrollTop:e},800);if(b.closest(".wrap_stars").hasClass("b-rating")){$(".comment_hint").html("Спасибо за оценку книги! Пожалуйста, добавьте комментарий, объясняющий вашу оценку.").show()}}},"json")},showLazyImg:function(b){var a=$(window).height();$(".lazy-img").each(function(){var c=$(this).data("src");if(!c){return true}if(actions.isVisible(this,0,a,"top","bottom")){this.src=c;$(this).data("src","")}})},isVisible:function(f,h,b,d,c){var g=f.getBoundingClientRect();var e=g[d]>=h&&g[d]<=b;var a=g[c]<=b&&g[c]>=h;return e||a},follow_user:function(a){a.preventDefault();if(getCookie("ar_session")!=""){$.post("/api/addAction.php",{t:$(this).data("action"),u:$(this).data("user-id")},function(b){if(b.status=="OK"){window.location.reload()}},"json")}else{authorization.get_auth_block()}return false},action_handlers:function(){var f=$(this).attr("data-action");var c=$(".book_info").data("bid");if(c&&f){if(f=="leave_comment"){var h=$(".comment_div").val();var e=($(".usr-rating").prop("style")["width"].replace("%",""))/20;var g=$("#uname").val();var a=$(".error_msg");if(h.length<5){a.text("Слишком короткий отзыв").show();return false}if(g.length>100){a.text("Слишком длинное имя").show();return false}var d="";if(typeof grecaptcha!=="undefined"){d=grecaptcha.getResponse(captcha)}$.post("/api/addAction.php",{t:f,b:c,comment:h,rating:e,user_name:g,response:d},function(k){if(k.status=="OK"){a.text("").hide();var j='<li><img class="user_pic" src="'+k.r.comment.user_avatar+'"><div class="overflow"><div class="user_name">'+k.r.comment.user_name+'</div><div class="user_rating"><div class="wrap_stars"><div class="fill" style="width: '+(k.r.comment.rating/5)*100+'%;"></div></div><div class="review_date">'+k.r.comment.date+'</div></div></div><div class="review_text"><p>'+k.r.comment.comment_text+"</p></div></li>";$(".reviews_container ul").prepend(j);$(".comment_div").val("");$("html,body").animate({scrollTop:$(".reviews_container ul").offset().top-70},800)}else{var b="Сервисные работы. Попробуйте чуть позже.";if(k.message){b=k.message}a.text(b).show();return false}},"json")}else{if(getCookie("ar_session")!=""){$.post("/api/addAction.php",{t:f,b:c},function(b){if(b.status=="OK"){window.location.reload()}},"json")}else{authorization.get_auth_block()}}}},save_settigs:function(){$("#msg_field").hide().attr("class","");var a=$(".profile_settings .field:visible");a.removeClass("error_state");var e=false;a.each(function(n,o){if(!o.value&&$(o).hasClass("required")){e=true;$(o).addClass("error_state")}});if(e){$("#msg_field").addClass("error_msg").html("Заполните, пожалуйста, все поля").show();return}if($("#new-pass").val()&&$("#new-pass").val()!=$("#repeat-new-pass").val()){$("#new-pass, #repeat-new-pass").addClass("error_state");$("#msg_field").addClass("error_msg").html("Пароли не совпадают").show();return}var h=/[-a-zA-Z0-9@:%_\+.~#?&//=]{2,256}\.[a-z]{2,4}\b(\/[-a-zA-Z0-9@:%_\+.~#?&//=]*)?/gi;var m=new RegExp(h);var j=$("#user-name").val();if(j.match(m)){$("#user-name").addClass("error_state");$("#msg_field").addClass("error_msg").html("Имя не может содержать ссылки").show();return}var k=$("#user-status").val();if(k){if(k.length>250){$("#user-status").addClass("error_state");$("#msg_field").addClass("error_msg").html("Максимальная длина статуса 250 символов").show();return}if(k.match(m)){$("#user-status").addClass("error_state");$("#msg_field").addClass("error_msg").html("Статус не может содержать ссылки").show();return}}var f=k;var b=j;var l=$("#user-gender").val();var c=$("#new-pass").val();var g=$("#user-subscribtion").is(":checked")?1:0;var d=$(".day_block").val()+"."+$(".month_block").val()+"."+$(".year_block").val();$.post("/api/addAction.php",{t:"save_user_info",status:f,name:b,gender:l,date:d,new_pass:c,subscribed:g},function(n){if(n.status=="OK"){$("#msg_field").addClass("success_msg").html("Изменения сохранены").show();setTimeout(function(){window.location.reload()},1000)}else{$("#msg_field").addClass("error_msg").html("Сервисные работы. Попробуйте, пожалуйста, позже.").show()}},"json");return false},show_search_form:function(){if($(".wrap_search").hasClass("is_show")){var a=$("#search-txt").val();if(a.length){window.location.href="/s/"+a}}else{$(".wrap_search").addClass("is_show");$(".header_menu").hide()}},show_mobile_menu:function(){if($(".header_menu").hasClass("mobile_menu")){$(".header_menu").removeClass("mobile_menu");$(".header_menu").hide()}else{$(".wrap_search").removeClass("is_show");$(".header_menu").show();$(".header_menu").addClass("mobile_menu")}},show_suggest:function(c){var a=$(this).val();if(c.which==13&&a.length>0){window.location.href="/s/"+a}var b=$(".wrap_search .dropdown");if(a.length<3){b.removeClass("is_show");return}$.get("/api/autosuggest.php?s="+a,function(d){if(d.trim()){b.html(d);b.addClass("is_show")}})}};var authorization={initFormHandlers:function(){$(".close_btn").click(function(){$(".auth_block").removeClass("is_show")});$(".login").click(function(){$(this).addClass("active");$(".register").removeClass("active");$(".login-tab").show();$(".register-tab").hide();return false});$(".register").click(function(){$(this).addClass("active");$(".login").removeClass("active");$(".register-tab").show();$(".login-tab").hide();return false});$("#reg").click(this.register);$("#login").click(this.login)},get_auth_block:function(){if($(".auth_block").length){$(".auth_block").addClass("is_show");return}else{$.ajax({url:"/api/authblock.php"}).done(function(a){$(".page_container").append(a);authorization.initFormHandlers()})}},register:function(){var d=$("#email_reg").val();var e=$("#pwd_reg").val();var c=$("#nickname_reg").val();var b=grecaptcha.getResponse(captcha);var a=$(".login-error-box");if(!d){alert($("#email").val());a.html("Заполните поле email").show();grecaptcha.reset(captcha);return false}if(!e){a.html("Заполните поле пароль").show();grecaptcha.reset(captcha);return false}if(!c){a.html("Укажите свое имя").show();grecaptcha.reset(captcha);return false}if(!b){a.html("Проверьте каптчу").show();grecaptcha.reset(captcha);return false}$.post("/api/recaptcha.php",{response:b}).done(function(f){if(f=="ok"){$.post("/api/form_handler.php",{type:"register",name:c,email:d,pwd:e}).done(function(g){var h=jQuery.parseJSON(g);if(h.status=="ok"){window.location.reload()}else{a.html(h.msg).show();grecaptcha.reset(captcha)}})}else{a.html("Проверьте каптчу").show();grecaptcha.reset(captcha)}});a.hide();return true},login:function(){var b=$("#email_login").val();var c=$("#pwd_login").val();var a=$(".login-error-box");if(!b){a.html("Заполните поле email").show();return false}if(!c){a.html("Заполните поле пароль").show();return false}$.post("/api/form_handler.php",{type:"login",email:b,pwd:c}).done(function(d){var e=jQuery.parseJSON(d);if(e.status=="ok"){window.location.reload()}else{a.html(e.msg).show();grecaptcha.reset(captcha)}});a.hide();return true},logout:function(){$.cookie("ar_session",null,{path:"/"});window.location.reload()}};function authorize(a){$.getJSON("//ulogin.ru/token.php?host="+encodeURIComponent(location.toString())+"&token="+a+"&callback=?",function(b){parsedJSON=$.parseJSON(b.toString());if(!parsedJSON.error){$.post("/api/form_handler.php",{type:"ulogin",jstring:b.toString()}).done(function(c){if(c=="success"){window.location.reload()}})}})}function getCookie(d){var b=d+"=";var a=document.cookie.split(";");for(var e=0;e<a.length;e++){var f=a[e];while(f.charAt(0)==" "){f=f.substring(1)}if(f.indexOf(b)==0){return f.substring(b.length,f.length)}}return""}actions.init();